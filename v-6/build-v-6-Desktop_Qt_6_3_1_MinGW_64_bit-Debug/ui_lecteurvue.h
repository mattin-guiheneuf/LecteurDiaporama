...
public:
    ...
    void setupUi(QMainWindow *lecteurvue)
    {
        ...
        cbPersonnage = new QCheckBox(centralwidget);
        cbPersonnage->setObjectName(QString::fromUtf8("cbPersonnage"));

        hLayoutFiltrage->addWidget(cbPersonnage, 3, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *lecteurvue)
    {
        ...
        cbPersonnage->setText(QCoreApplication::translate("lecteurvue", "Personnages", nullptr));
